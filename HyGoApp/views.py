...
def posts(request):
	...
	if request.user.is_authenticated():
		...
		posts_message="<h2 style='color:green;textalign:center;'> No posts found<hr>Please <span style='color:navy;'>login</span> to the see protected posts</h2><hr><h3 style='color:blue;text-align:center;'>Username:  <span style='color:orange;'>Rishikesh67</span><hr><br>Password: <span style='color:orange;'>admin@321</span></h3>"
